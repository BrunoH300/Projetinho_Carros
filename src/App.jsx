...
export default function App(){
  ...
  <main className=" min-h-svh bg-offwhitebg py-20 px-6">
    ...
    <h2 className="font-shoulders mb-7 uppercase 4xl font-bold text-white">Sedans</h2>
    ...
    <div className="bg-green p-12">
      ...
      <h2 className="font-shoulders mb-7 uppercase 4xl font-bold text-white">SUVs</h2>
...
<img src={Luxury} alt="icone luxo" className="mb-7"/>
    <h2 className="font-shoulders mb-7 uppercase 4xl font-bold text-white">Luxury</h2>
